 ...
 * pass. Packing therefore checks each coefficient as it goes and fails rather
 * than truncating, which turns the modelling assumption into something an
 * honest run can falsify.
 *
 * @ingroup serial
 */
...
/**
 * Pack and unpack the published projection, PROJ residues bounded by the
 * range proof's norm check.
 */
